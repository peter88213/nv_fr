[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Pages en français](../) > [${Online help}](./) > Chapitre menu
...
With **Chapitre > ${Show chapter structure board in browser}**, You can create a HTML file
